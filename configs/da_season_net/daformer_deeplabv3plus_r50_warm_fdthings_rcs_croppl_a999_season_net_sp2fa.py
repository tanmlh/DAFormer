...
_base_ = [
    ...
    '../_base_/datasets/uda_season_net_sp2fa_128x128.py',
...
name = 'daformer_deeplabv3plus_r50_warm_fdthings_rcs_croppl_a999_season_net_sp2fa'
exp = 'basic'
name_dataset = 'season_net_sp2fa'
