...
_base_ = [
    ...
    '../_base_/datasets/uda_inria_da_512x512.py',
...
name = 'fmda_deeplabv3plus_r50_warm_croppl_a999_ada_pse00_inria_da'
exp = 'basic'
name_dataset = 'inria_da'
name_architecture = 'fmda_deeplabv3plus_r50'
name_encoder = 'r50'
