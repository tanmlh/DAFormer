...
class PseudoLabelingHookV3(Hook):
    ...
    def before_run(self, runner):
        super(PseudoLabelingHookV3, self).before_run(runner)
    ...
    def after_train_iter(self, runner):
        super(PseudoLabelingHookV3, self).after_train_iter(runner)
    ...
    def after_train_epoch(self, runner):
        pdb.set_trace()
        super(PseudoLabelingHookV3, self).after_train_epoch(runner)
        pass
