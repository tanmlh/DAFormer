...
from daseg.core import eval_metrics
from daseg.utils import get_root_logger
from .builder import DATASETS
from .pipelines import Compose, LoadAnnotations
from Dataset4EO.datasets import load
...
class EODataset(Dataset):
    def __init__(self,
        ...
        self._dataset = load(datapipe, root=data_root, split=self.split, **datapipe_cfg)
    ...
    def get_gt_results_by_idx(self, index):
        """Get one ground truth segmentation map for evaluation."""
        ann_info = self.get_ann_info(index)
        results = dict(ann_info=ann_info)
        self.pre_pipeline(results)
